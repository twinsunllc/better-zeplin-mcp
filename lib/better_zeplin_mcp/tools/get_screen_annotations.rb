...
module BetterZeplinMcp
  module Tools
    class GetScreenAnnotations < BetterZeplinMcp::BaseTool
      name 'get_screen_annotations'
      desc 'Get annotations on a screen'
      ...
      def call(project_id:, screen_id:, limit: 100, offset: 0)
        response = client.get("/projects/#{project_id}/screens/#{screen_id}/annotations", 
